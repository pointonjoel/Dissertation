...
\begin{document}
%Title----------------------------------------------
\title{Evolution of the Ethnic Wage Gap}
\subtitle{Main findings}
\author[Pointon, Joel]{J.~Pointon\\\includegraphics[width=2.3cm]{./images/kent_logo.jpg}}
...
\begin{textblock*}{110mm}(1.025\textwidth,0.8cm)
\includegraphics[width=0.15\textwidth]{./images/kent_logo.jpg}
\end{textblock*}}
%2 - Theory----------------------------------------------
\begin{frame}[t]{The Economics of Discrimination}
\onslide<1->{
		\begin{itemize}
			\item A lack of ethnicity research, particularly recently and across time
...
\onslide<1->{
			\begin{itemize}
				...
				\item Merged 1997-2019 inclusive
